...
// updated by DevHelper_Helper_ShippableHelper at 2017-08-09T08:02:30+00:00

/**
 * Class bdMails_ShippableHelper_Updater
 * @version 7
...
class bdMails_ShippableHelper_Updater
{
    ...
    public static function onInitDependencies(
        ...
        $GLOBALS[self::KEY]['version'][$apiUrl][self::$_version]
            = 'bdMails_ShippableHelper_UpdaterCore';
    ...
    public static function onUninstall($apiUrl = null, $addOnId = null)
    {
        ...
        if (empty($activeAddOnIds)) {
            ...
            bdMails_ShippableHelper_UpdaterCore::_uninstallSelf($apiUrl);
        }
    }
